...
export const ReservationTicket = () => {
    ...
    return (
        <section className="w-full flex-grow flex items-center justify-center p-4">
            <div className="flex w-full max-w-3xl text-zinc-50 h-24">
                ...
                <div className="relative flex flex-col items-center border-dashed justify-between border-2 bg-zinc-900 border-zinc-50">
                ...
                <div className="px-10 bg-zinc-900 rounded-r-3xl flex flex-col">
                    <div className="flex">
