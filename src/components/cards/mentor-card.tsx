...
export function MentorCard({
    ...
    return (
        <div className="dark:bg-[#00528A] bg-white flex flex-col justify-center p-6 shadow-md rounded-xl">
            <div className="space-y-4 text-center">
                <div className="my-2 space-y-1 flex flex-col items-center">
                    ...
                    <h2 className="text-l font-bold sm:text-2xl truncate capitalize dark:text-[#ffffff]">
                        {mentor.name}
                    </h2>

                    <p className="px-5 text-xs sm:text-base text-foreground flex items-center gap-x-1">
                        <PiMedalFill className="h-4 w-4 text-[#FFE600]"/>
                        <span className="text-sm dark:text-[#ffffff]">Tutor</span>
                    </p>
