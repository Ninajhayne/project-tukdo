...
//import { myCourseRating } from "@/lib/rating/get-my-course-rating";
import { CourseRating } from "@prisma/client";
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            if (initialData) {
                ...
                await axios.post(`/api/ratings/course-ratings/${courseId}`, values);
            }
        ...
        <Dialog /*open={isModalOpen}*/ onOpenChange={handleClose}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        How was the quality of the course?
                    </DialogDescription>
                </DialogHeader>
